...
export const categoryColorMap: Record<string, { bg: string; text: string; darkBg: string; darkText: string; hoverBg: string; darkHoverBg: string; hoverText?: string; darkHoverText?: string; }> = {
  ...
  "Всички": { bg: "bg-gray-900", text: "text-white", darkBg: "dark:bg-white", darkText: "dark:text-gray-900", hoverBg: "hover:bg-gray-700", darkHoverBg: "dark:hover:bg-gray-300", hoverText: "hover:text-white", darkHoverText: "dark:hover:text-gray-900" },
};

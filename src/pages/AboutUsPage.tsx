  ...
  return (
    <InfoDrawerContent title="ЗА НАС" isOpen={isOpen} onClose={onClose}>
      <div className="flex items-center justify-center mb-6">
        {/* Using the full logo SVG from Index.tsx, scaled down, with debugging styles */}
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 481 134"
          className="w-auto h-12 fill-gray-900 dark:fill-white transition-colors duration-300 bg-red-500 border-2 border-green-500 overflow-visible">
          <defs>
            <g id="Layer0_0_FILL">
